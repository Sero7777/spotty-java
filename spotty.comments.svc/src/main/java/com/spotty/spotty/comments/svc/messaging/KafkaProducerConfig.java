...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, String> producerFactoryCommentDeleteEvent() {
        return new DefaultKafkaProducerFactory<>(producerConfig());
    }
    ...
    @Bean
    public KafkaTemplate<String, String> kafkaTemplateCommentDeleteEvent() {
        return new KafkaTemplate<>(producerFactoryCommentDeleteEvent());
    }
}
